  ...
  return (
    ...
    <p className='text-center py-8'>
      ...
      <div className='grid sm:grid-cols-2 gap-12'>
        <ProjectItem img={barberosImg} title='Barbers App'/>
        <ProjectItem img={paresImg} title='Pares App'/>
        <ProjectItem img={plantitosImg} title='Plantitos App'/>
        <ProjectItem img={primeVideoImg} title='Prime App'/>
      </div>
    </div>
  )
}
